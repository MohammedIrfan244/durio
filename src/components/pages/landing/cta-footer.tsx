        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center">
          ...
          >
            <h2 className="text-4xl sm:text-6xl md:text-8xl font-black font-[family-name:var(--font-heading)] text-white drop-shadow-lg leading-none">
              Ready?
              <br />
              <span className="inline-block mt-4 -rotate-3 text-white">
                I&apos;ve been waiting.
              </span>
            </h2>
              ...
              <Link href="/dashboard">
                ...
                >
                  ...
                  >
                    <Button
                      size="lg"
                      className="w-full sm:w-auto bg-white text-[#ff6a00] hover:bg-orange-50 font-[family-name:var(--font-heading)] font-bold text-xl sm:text-2xl rounded-[2rem] px-8 sm:px-12 py-8 sm:py-10 shadow-2xl transition-all border-b-8 border-orange-200"
                    >
                      Let&apos;s start
                    </Button>
                  </motion.div>
